...
function Footer() {
  return (   
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 my-3">
            <div>
                ...
                <ul className="text-white dark:text-white">
                    <li className="mb-4">
                        <a href="https://flowbite.com/" className="hover:underline">Lorem ipsum</a>
                    </li>
                    <li>
                        <a href="https://tailwindcss.com/" className="hover:underline">Lorem, ipsum.</a>
                    </li>
                </ul>
            </div>
            <div>
    ...
    {/* <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-white sm:text-center dark:text-white">© 2022 Team Elves. All Rights Reserved.
        </span>
    ...
    <div className='bg-light-purple w-auto'>
    {/* <hr class="my-6 border-gray-700 sm:mx-auto dark:border-gray-700 lg:my-8" /> */}
    <span class="block p-3 text-sm text-black sm:text-center dark:text-gray-400">© 2022 
        Team Elves. All Rights Reserved.
    </span>
    </div>
</footer>
    </div>
