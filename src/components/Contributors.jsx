...
function Contributors() {
    return (
        <div className="contributers w-full h-[max-content] mt-14">
                    ...
                    <div className="grid gap-x-6 lg:gap-x-12 md:grid-cols-5">
                        <div className="mb-24 md:mb-0">
                            <div className="rounded-lg shadow-lg h-full block bg-white">
                                ...
                                <div className="p-6">
                                    <h5 className="text-md font-bold mb-4">Aryan</h5>
                        ...
                        <div className="mb-24 md:mb-0">
                            <div className="rounded-lg shadow-lg h-full block bg-white">
                                ...
                                <div className="p-6">
                                    <h5 className="text-md font-bold mb-4">Simron Bhuyan</h5>
                                    <p className="mb-6">Frontend Developer</p>
                                    <ul className="list-inside flex mx-auto justify-center">
                                        <a href="#!" className="px-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-4 h-4 text-blue-600">
                        ...
                        <div className="mb-24 md:mb-0">
                            <div className="rounded-lg shadow-lg h-full block bg-white">
                                ...
                                <div className="p-6">
                                    <h5 className="text-md font-bold mb-4">Khusi Das Mohapatra</h5>
                                    <p className="mb-6">Frontend Developer</p>
                                    <ul className="list-inside flex mx-auto justify-center">
                                        <a href="#!" className="px-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-4 h-4 text-blue-600">
                        ...
                        <div className="mb-24 md:mb-0">
                            <div className="rounded-lg shadow-lg h-full block bg-white">
                                ...
                                <div className="p-6">
                                    <h5 className="text-md font-bold mb-4">Padmakshi Mandal</h5>
                        ...
                        <div className="">
                            <div className="rounded-lg shadow-lg h-full block bg-white">
                                ...
                                <div className="p-6">
                                    <h5 className="text-md font-bold mb-4">Ipsita Satapathy</h5>
            ...
            {/*  <div className="container w-[100vw] flex-wrap h-[max-content] justify-around flex">
